...
Complétez le fichier de test CalculateurTest.cpp présent dans le dossier Google_tests qui utilise la librairie Google Test. 
...
Complétez le fichier de test ManipulateurDeChainesTest.cpp présent dans le dossier Google_tests. 
...
Complétez le fichier de test PanierAchatTest.cpp présent dans le dossier Google_tests. 
Le but de cette exercice est de pouvoir identifier les principes FIRST dans des tests
unitaires. Vous devez corriger les tests présents dans le fichier de PanierAchatTest.cpp afin de respecter ces principes.
